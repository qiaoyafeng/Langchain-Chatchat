...
conda run -n chatchat  --no-capture-output export CHATCHAT_ROOT=/opt/python/Langchain-Chatchat/libs/chatchat-server/chatchat-data && chatchat start -a > >(tee chatchat-output.log) 2>&1 &
PID=$!
